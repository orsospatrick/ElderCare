	...
	<div class="container-login100">
		<div class="wrap-login100">
			<form class="login100-form validate-form" method="post">
				<?php 
					$errors = "success";
					$con = mysqli_connect("localhost", "root", "", "proiectip") or die("conectare esuata");
					if(isset($_POST["adaugareSchema"]))
					{
						$schemaMedicatie = mysqli_real_escape_string($con, $_POST["schemaMedicatie"]);
                        $id_medic = mysqli_real_escape_string($con, $_POST["id_medic"]);
                        $tratament = mysqli_real_escape_string($con, $_POST["tratament"]);
						$id_pacient=$_GET["id_click"];
						if(empty($schemaMedicatie)||empty($id_medic)||empty($tratament))
						{
						...
						if($errors=="success")
						{
							$sql = "INSERT INTO schememedicatie(id_medic, id_pacient, schemaMedicatie, tratament) VALUES('$id_medic', '$id_pacient', '$schemaMedicatie', '$tratament')";
				...
				<div class="wrap-input100 validate-input">
					<input class="input100" type="text" name="id_medic" autocomplete="off" placeholder="Id-ul medicului">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Introduceti prenumele">
					<input class="input100" type="text" name="schemaMedicatie" autocomplete="off" placeholder="Schema de medicatie">
					<span class="focus-input100"></span>
                </div>
                
                <div class="wrap-input100 validate-input" data-validate = "Introduceti prenumele">
					<input class="input100" type="text" name="tratament" autocomplete="off" placeholder="Tratament">
					<span class="focus-input100"></span>
				</div>

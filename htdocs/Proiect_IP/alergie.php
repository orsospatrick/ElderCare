			...
			<form class="login100-form validate-form" method="post">
				<?php 
					...
					if(isset($_POST["adaugareSchema"]))
					{
						...
						if(empty($tipAlergie)||empty($id_medic)||empty($simptome))
						{
						...
						if($errors=="success")
						{
							$sql = "INSERT INTO alergii(id_medic, id_pacient, tipAlergie, simptome) VALUES('$id_medic', '$id_pacient', '$tipAlergie', '$simptome')";

...
<body onload="myFunction()">
    ...
    $sql = "SELECT  nume, prenume, cnp, data_nasterii, sex, adresa, telefon, email FROM utilizator WHERE id='$id_pacient'";
    ...
    while($row = $result_scheme->fetch_assoc())
    {
        ...
        echo "<h3><br>SCHEMA DE MEDICATIE: ".$row['schemaMedicatie'] . ":</h3>";
        echo "<h3><br>TRATAMENT: ".$row['tratament'] . ":</h3>";
    }

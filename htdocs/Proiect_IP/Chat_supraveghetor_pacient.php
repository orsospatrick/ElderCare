...
session_start();
    include './NavBar_supraveghere.php';
    $id_pacient=$_GET['id_click'];
    $id_supraveghetor = $_SESSION['id_supraveghetor'];
...
<body>
  ...
  <form class="form-container" method="post">
    <h1>Chat</h1>
      ...
      <textarea rows="9" cols="4" id="message_chat" name="message_chat" required ><?php echo $text;?></textarea>

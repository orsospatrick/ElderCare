			...
			<form class="login100-form validate-form" method="post">
				<?php 
					...
					if(isset($_POST["adaugareSchema"]))
					{
						...
						if ((empty($schemaMedicatie) && $schemaMedicatie!="0") || (empty($tratament) && $tratament!="0"))
						{
						...
						if($errors=="success")
						{
							$sql = "INSERT INTO schememedicatie(id_pacient, schemaMedicatie, tratament) VALUES('$id_pacient', '$schemaMedicatie', '$tratament')";

		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post">
                    ...
                    $sql = "SELECT *FROM utilizator WHERE id='$id'";
					...
					if (isset($_POST["inregistrare"])) {
						...
						if ((empty($utilizator) && $utilizator!="0") || (empty($parola) && $parola!="0") || (empty($nume) && $nume!="0")
						 ...
						 || (empty($tara) && $tara!="0") || (empty($profesie) && $profesie!="0") || (empty($loc_munca) && $loc_munca!="0")) {
						...
						if ($errors == "success") {
							...
							$sql = "UPDATE utilizator 
                                    SET utilizator='$utilizator',parola='$parola',tip='$tip',nume='$nume',prenume='$prenume',cnp='$cnp',data_nasterii='$data',sex='$gen',
                                    adresa='$adresa',telefon='$telefon',email='$email',profesie='$profesie',loc_munca='$loc_munca'
								    WHERE id='$id'";
					...
					<span class="login100-form-title p-b-43">
						Modificati datele pacientului
					</span>

					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="utilizator" autocomplete="off" placeholder="Utilizator" value="<?php echo $row["utilizator"]?>">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="nume" autocomplete="off" placeholder="Nume" value="<?php echo $row["nume"]?>">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Introduceti prenumele">
						<input class="input100" type="text" name="prenume" autocomplete="off" placeholder="Prenume" value="<?php echo $row["prenume"]?>">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Introduceti telefonul">
						<input class="input100" type="text" name="telefon" autocomplete="off" placeholder="Telefon" value="<?php echo $row["telefon"]?>">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Introduceti CNP-ul">
						<input class="input100" type="text" name="cnp" autocomplete="off" placeholder="CNP" value="<?php echo $row["cnp"]?>">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input">
							<div class="row" >
								<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="form-group" style="width:450px;">
											<!-- Date input -->
											<input class="input100" id="date" style="margin-top:9px" name="date" placeholder="Data nasterii" type="text" value="<?php echo $row["data_nasterii"]?>"/>
											<span class="focus-input100"></span>
										</div>
								</div>
							</div>						
					...
					<div class="wrap-input100 validate-input" data-validate="Introduceti genul">
						<input class="input100" type="text" name="gen" autocomplete="off" placeholder="Gen" value="<?php echo $row["sex"]?>">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Introduceti adresa de email">
						<input class="input100" type="text" name="email" autocomplete="off" placeholder="Email" value="<?php echo $row["email"]?>">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Introduceti tara">
						<input class="input100" type="text" name="tara" autocomplete="taraJudet" placeholder="Adresa" value="<?php echo $row["adresa"]?>">
						<span class="focus-input100"></span>
                    </div>
                    
                    <div class="wrap-input100 validate-input" data-validate="Introduceti tara">
						<input class="input100" type="text" name="profesie" autocomplete="off" placeholder="Profesie" value="<?php echo $row["profesie"]?>">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Introduceti locul de munca">
						<input class="input100" type="text" name="loc_munca" autocomplete="off" placeholder="Locul de munca" value="<?php echo $row["loc_munca"]?>">
						<span class="focus-input100"></span>
					</div>

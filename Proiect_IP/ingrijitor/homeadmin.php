	...
	<div class="limiter">
		<table class="table table-striped table-responsive-sm">
			...
			<tbody>
				...
				$sql_id = "SELECT id_ingrijitor, id_pacient FROM ingrijitor_pacient WHERE id_ingrijitor='$id_ingrijitor'";
				...
				while ($row = $result->fetch_assoc()) {
					...
					if($tip=="pacient")
					{
						...
						?>
						<tr onclick="window.location='./homeadmin.php?id_click=<?php echo $id_click ?>&id_ingrijitor=<?php echo $id_ingrijitor?>';">
							<?php
							unset($row["id"]);
							unset($row["tip"]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button onclick="window.location.href='./rezolvarealarma.php?id_click=<?php echo $_GET['id_click']; ?>&id_ingrijitor=<?php echo $id_ingrijitor?>'" type="button" class="btn btn-light btn-block">Rezolvare alarme</button>
				<button onclick="window.location.href='./adaugaredatefiziologice.php?id_click=<?php echo $_GET['id_click']; ?>&id_ingrijitor=<?php echo $id_ingrijitor?>'" type="button" class="btn btn-light btn-block">Adaugare date fiziologice</button>
			</div>

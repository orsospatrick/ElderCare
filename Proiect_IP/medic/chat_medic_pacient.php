...
<head>
    ...
    if (isset($_POST["send_message"])) {
        ...
        $sql = "INSERT INTO chat_medic_pacient(id_pacient,id_medic,mesaj,emitator) 
        VALUES ('$id_pacient', '$id_medic', '$mesaj_supraveghetor' ,'$emitator' )";
    ...
    $sql = "SELECT mesaj,emitator FROM chat_medic_pacient WHERE id_pacient='$id_pacient'";
    $result = $con->query($sql);
    while ($row = $result->fetch_assoc()) {
        if ($row["emitator"] == "medic") {
            $text = $text . "Medic: " . $row["mesaj"] . "&#13;&#10;";
        } else
